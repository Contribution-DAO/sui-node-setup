...
wget -O /usr/local/bin/sui-node https://sui-releases.s3.us-east-1.amazonaws.com/2698314d139a3018c2333ddaa670a7cb70beceee/sui-node && chmod +x /usr/local/bin/sui-node
